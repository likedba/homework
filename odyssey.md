...
0. [Почему для PostgreSQL необходим пулер соединений](#Почему-для-PostgreSQL-необходим-пулер-соединений)
1. [Преимущества odyssey](#Преимущества-odyssey)
2. [Установка odyssey](#Установка-odyssey)
    1. [Требования](#Требования)
    2. [Установка](#Установка)
3. [Настройка Odyssey](Настройка-Odyssey)
    1. [Общие настройки](#Общие-настройки)
    2. [Настройка маршрутов](#Настройка-маршрутов)
        1. [Секция listen](#Секция-listen)
        2. [Секция storage](#Секция-storage)
        3. [Секция Database](#Секция-database)
4. [Проверка работы Odyssey](#Проверка-работы-Odyssey)
5. [Тест производительности БД с пулером и без](#Тест-производительности-БД-с-пулером-и-без)
    1. [Производительность БД без пулера](#Производительность-БД-без-пулера)
    2. [Производительность БД с пулером](#Производительность-БД-с-пулером)
    3. [Производительность БД с пулером на отдельном хосте](#Производительность-БД-с-пулером-на-отдельном-хосте)
7. [Вывод](#Вывод)
